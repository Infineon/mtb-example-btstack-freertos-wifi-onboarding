...
APPNAME=mtb-example-anycloud-ble-wifi-onboarding
...
# added to the build
#
COMPONENTS=FREERTOS LWIP MBEDTLS WICED_BLE CUSTOM_DESIGN_MODUS
...
DEFINES=$(MBEDTLSFLAGS) CYBSP_WIFI_CAPABLE CY_RETARGET_IO_CONVERT_LF_TO_CRLF CY_RTOS_AWARE CY_SD_HOST_CLK_RAMP_UP_TIME_MS_WAKEUP=0
